...
public class Phase2{
    static char M [][] = new char [300][4];	//Memory 3(100*4)
    ...
    static int RandomNumbersGenerated [] = new int[100];
    ...
    private static void writeTwoBlankLines() {
        ...
        File file = new File("C:\\Users\\Hp\\IdeaProjects\\Multiprogramming_OS\\outputPhase2.txt");
        FileWriter fr = null;
